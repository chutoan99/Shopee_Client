...
//? APPS
import { useGetCategoryTreeParentQuery } from '../hook'

function CategoryFilterComponent(): JSX.Element {
    ...
    <div className='min-w-0 ml-0 mr-5 mt-0 mb-5'>
      {params.display_name && (
        <div className='text-[rgba(0,0,0,0.8)]'>
          <NavLink
            className='capitalize no-underline text-[rgba(0,0,0,0.8)] h-[3.125rem] leading-[3.125rem] font-bold text-base block flex items-center mb-2.5 border-b-[rgba(0,0,0,0.05)] border-b border-solid'
            to='/'
          >
            <svg viewBox='0 0 12 10' className='text-xs stroke-current inline-block w-[1em] h-[1em] fill-current relative mr-2.5 '>
        ...
        <div>
          <div className='cursor-pointer flex items-center h-[1.5625rem] whitespace-nowrap px-3 py-0'>
            <div className='flex mb-px'>
              <svg viewBox='0 0 9.5 8' className='text-[#ffce3d] inline-block w-[1em] h-[1em] fill-current relative ml-0 mr-1 my-0'>
                <defs>
          ...
          <div className='cursor-pointer flex items-center h-[1.5625rem] whitespace-nowrap px-3 py-0'>
            <div className='flex mb-px'>
              ...
              <div className='text-[#ffce3d] ml-0 mr-1 my-0 relative' style={{ width: 14, height: 14 }}>
                ...
                <svg viewBox='0 0 30 30' className='w-full h-full absolute left-0 top-0' style={{ width: '0%' }}>
                  <defs>
