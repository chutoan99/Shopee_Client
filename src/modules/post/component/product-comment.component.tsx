...
import { useGetCommentsQuery } from '../../comment/hook';
                    ...
                    return (
                      ...
                      >
                        <div className="w-[2.5rem] h-[2.5rem]">
                          <img src={item?.author_portrait} alt="item" className="w-full h-full rounded-[50%]" />
                        </div>
                        <div className="flex flex-col gap-[5px]">
                          ...
                          {item?.comment_rep === null ? null : (
                            <div className="bg-neutral-100 relative mt-3 px-3 py-3.5">
                              <h3 className="text-[#8b572a] text-sm capitalize">Phản Hồi Của Người Bán</h3>
                              <p className="text-[rgba(0,0,0,0.87)] whitespace-pre-wrap mt-2.5">{item?.comment_rep?.comment}</p>
                            </div>
                          )}
                          <div className="flex text-[rgba(0,0,0,0.4)] mt-[1.25rem] gap-[7px]" onClick={handleChangeStatus}>
