...
//? APPS
import { IShopInterface } from '../../shop/interface'
import { AppDispatch } from '../../../app/store'
import { useAppDispatch } from '../../../hooks/hooks'
import { OtherActions } from '../../../redux/otherSlice'
import { useCreateRoomMutation } from '../../room/hook'
      ...
      <div className='grid wide'>
        <div className='flex shadow-[rgba(0,0,0,0.05)_0px_1px_1px_0px] overflow-hidden justify-between items-center mt-[0.9375rem] p-[1.5625rem] rounded-sm bg-[#fff]'>
          <div className='box-border flex max-w-[27.5rem] pr-[1.5625rem] border-r-[rgba(0,0,0,0.05)] border-r border-solid'>
            <div onClick={() => navigate(`/shop/${data?.shopid}`)} className='shrink-0 relative overflow-visible mr-5'>
              <div className='inline-block relative border box-border w-[5rem] h-[5rem] rounded-[50%] border-solid border-[rgba(0,0,0,0.09)]'>
                ...
                <img className='absolute w-full h-full block max-w-full rounded-[50%] left-0 top-0' src={data?.portrait} alt='' />
              </div>
            </div>
            <div className='grow flex flex-col justify-between overflow-hidden'>
              ...
              <div className='flex mt-[8px]'>
                ...
                >
                  <svg viewBox='0 0 16 16' className='inline-block w-[1em] h-[1em] fill-current relative shrink-0 mr-[5px]'>
                    <g fillRule='evenodd'>
                ...
                <button
                  ...
                  style={{ border: '1px solid #ccc', outline: 'none', background: '#fff', WebkitLineClamp: 1 }}
                >
                  <svg
          ...
          <div className='!grid grid-cols-[repeat(3,auto)] gap-[1.25rem_3.125rem] text-[rgba(0,0,0,0.4)] grow pl-[1.5625rem]'>
            <div className='cursor-default flex justify-between relative overflow-visible'>
              ...
              <span className='text-[#ee4d2d] whitespace-nowrap text-right'>{data?.rating_bad + data?.rating_good + data?.rating_normal}</span>
            </div>
            <div className='cursor-default flex justify-between relative overflow-visible'>
            ...
            <NavLink className='cursor-default flex justify-between relative overflow-visible' to='/'>
