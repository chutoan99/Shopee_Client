					...
					<div className='col-lg-12'>
						<div className='bg-[#fff] overflow-hidden mt-[0.9375rem] p-2.5 rounded-sm'>
							<div className='pt-[0.9375rem] pb-0 px-[0.9375rem]'>
								<p className='text-lg text-[rgba(0,0,0,0.87)] capitalize mb-[1em]'>
									ĐÁNH GIÁ SẢN PHẨM
								</p>
									...
									<div className='text-center h-[84px] mr-[1.875rem]'>
										<div>
											<span className='text-[#ee4d2d] text-[1.875rem]'>
												4.9{' '}
												<label className='text-[#ee4d2d] text-[1.125rem]'>
													trên 5
												</label>
											</span>
										</div>
										<div className='flex !text-[#ee4d2d] !text-3xl'>
											{generateStart(5)}
										</div>
									</div>
									<div>
									...
									<div className='flex flex-col items-center px-0 py-[100px]'>
										<div className='w-full h-full flex justify-center'>
											<img
												...
												alt='emptyComment'></img>
										</div>
										<p className='text-base text-[rgba(0,0,0,0.8)] mt-3'>
					...
					{item?.images?.map((img: any, index_img: any) => {
						return (
							<div
								...
								key={index_img}
								onClick={() =>
									setImgActive(item?.images[index_img])
								}>
								<img
									src={img}
									alt='item'
