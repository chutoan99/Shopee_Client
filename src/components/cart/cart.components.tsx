        ...
        >
          {totalCart > 0 ? (
                      ...
                      <div key={index}>
                        {item.map((ele: ICart, index: number) => (
                          <li className='flex' key={index}>
                            <img className='w-[42px] h-[42px] border m-3 border-solid border-[#e8e8e8]' src={ele?.item?.image} alt='dataCart' />
            ...
            <div className='py-[20px] px-[10px]'>
              <img src='/assets/Img/no-cart.png' alt='noCart' className='flex justify-center max-w-full h-auto w-[54%] mx-auto border-none' />
