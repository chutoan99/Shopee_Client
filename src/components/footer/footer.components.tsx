        ...
        <div className='row pt-[50px]'>
          ...
          <div className='col l-2-4 mo-3 c-6'>
            ...
            <ul className='pl-0' style={{ listStyle: 'none' }}>
              ...
              <li>
                <NavLink to='https://www.instagram.com/Shopee_VN/' className=' no-underline text-xs text-neutral-500 flex items-center px-0'>
                  <span className='text-base ml-0 mr-2 mb-0'>
              ...
              <li>
                <NavLink to='https://www.linkedin.com/company/shopee' className=' no-underline text-xs text-neutral-500 flex items-center px-0'>
                  <span className='text-base ml-0 mr-2 mb-0'>
