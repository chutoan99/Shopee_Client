                ...
                <div className="col l-2 mo-4 c-6" key={index}>
                  <div className="relative shadow-[0_1px_2px_rgba(0,0,0,0.1)] transition-transform duration-[linear] delay-[0.1s] mt-[5px] pb-[5px] rounded-sm bg-[#fff]">
                    <div
                      ...
                      style={{ height: '191px' }}
                    >
                      <LoadingSkeleton className="mb-[5px] w-full cursor-pointer bg-[top_center] bg-contain bg-no-repeat rounded-br-sm rounded-bl-sm h-full"></LoadingSkeleton>
                    </div>
                    <div className="text-sm h-9 ml-1.5 mr-2.5 my-2.5" style={{ height: '36px' }}>
                      <LoadingSkeleton className="w-full mb-1 h-9  ml-1.5 mr-2.5 my-2.5"></LoadingSkeleton>
                    </div>
                    <div className="text-sm h-9 ml-1.5 mr-2.5 my-2.5" style={{ height: '36px', marginTop: 'unset' }}>
                      <LoadingSkeleton className="w-full mb-1 h-9 ml-1.5 mr-2.5 my-2.5"></LoadingSkeleton>
                    </div>
                  </div>
                </div>
