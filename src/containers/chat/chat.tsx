...
function Chat() {
  ...
  return (
    <div className="right-[10px] bottom-[10px] z-10" style={{ position: 'fixed' }}>
      {isPopupChat && (
        <div className="UvGSSkd1qQ">
          <div className="PBqe51NF33" style={{ borderBottom: '1px solid #ccc' }}>
            <div className="Ffl5D3J1YM">
              ...
              <div className="t0DSoDjLOv">
                {/* <i className="GHUxSkxNuJ GQqiEMsjau">
                  <svg viewBox="0 0 3 12" xmlns="http://www.w3.org/2000/svg" className="chat-icon">
            ...
            <div className="zhhA1X0YeX">
              <div className="b4WLaPHvaN" onClick={onToggleListChat}>
                <div className="">
                  <i className="GHUxSkxNuJ MSU7d8LTb3 X8XVK1EpGd">
                    {isListChat ? (
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className="chat-icon">
              ...
              <div className="b4WLaPHvaN" onClick={() => setIsPopupChat(false)}>
                <div className="">
            ...
            <div className="  w-full flex">
                        ...
                        <div className=" w-full px-[10px]">
                          <div className="flex justify-between  w-full">
                            <div className="flex gap-[7px]">
                              <div className="">
                                <i className="GHUxSkxNuJ qOaLA04T54 gDgAxvNNrx d1YabInLx8">
                              ...
                              <div>
                                ...
                                <div className="">
                                  <i className="GHUxSkxNuJ Yi_y3RUsrz gDgAxvNNrx d1YabInLx8">
                              ...
                              <div>
                                ...
                                <div className="">
                                  <i className="GHUxSkxNuJ Q7rLjdhNkf gDgAxvNNrx d1YabInLx8">
                                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="chat-icon">
                                      <path
                                        fillRule="evenodd"
                                        clipRule="evenodd"
                              ...
                              <div className="">
                                <i className="GHUxSkxNuJ spupFetcv_ gDgAxvNNrx d1YabInLx8">
                                  <svg viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" className="chat-icon">
                              ...
                              <div className="">
                                <i className="GHUxSkxNuJ QkUaqpPKl8 gDgAxvNNrx d1YabInLx8">
                                  <svg viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" className="chat-icon">
                            ...
                            <i className="GHUxSkxNuJ efElYaAvMZ plW8rzAMob cursor-pointer" onClick={onAddMess}>
              ...
              <div className=" w-[220px] bg-white">
                <div
                  ...
                  role="grid"
                  style={{ boxSizing: 'border-box', direction: 'ltr', width: '220px', willChange: 'transform', overflow: 'auto' }}
                >
                  {!isLoading && (
                    <ItemChat
                      data={listRoom || []}
      ...
      {!isPopupChat && (
        <div className="right-[10px] bottom-[10px] z-10" style={{ position: 'fixed' }} onClick={() => setIsPopupChat(true)}>
