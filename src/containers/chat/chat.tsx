...
function Chat() {
  ...
  return (
    <div className="right-[10px] bottom-[10px] z-10" style={{ position: 'fixed' }}>
      {isPopupChat && (
        <div className="bg-white border shadow-[0_4px_20px_0_rgb(74_74_78_/_16%)] h-[502px] relative translate-x-0 transition-[width] duration-[0.25s] ease-[cubic-bezier(0.4,0.8,0.74,1)] border-solid border-[#dcdce0]">
          <div
                        ...
                        <div className="w-full px-[10px]">
                          <div className="flex justify-between  w-full">
                            ...
                            <i
                              ...
                              onClick={onAddMess}
                            >
                              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill={message && '#f7472e'}>
        ...
        <div className="right-[10px] bottom-[10px] z-10" style={{ position: 'fixed' }} onClick={() => setIsPopupChat(true)}>
          <div className="items-center shadow-[0_4px_20px_0_rgb(28_28_51_/_16%)] box-border flex h-12 justify-between relative translate-x-0 origin-bottom-right transition-[background-color] duration-[0.15s] ease-[ease-out] w-[100px] bg-[#ee4d2d] rounded-[4px_4px_0_0]">
            <div className="justify-center items-center cursor-pointer flex p-3">
              <div className="border box-border text-white text-xs h-[18px] overflow-hidden absolute top-[-9px] px-[5px] py-px rounded-[9px] border-solid border-[#f6f6f6] -right-1 bg-[#ee4d2d]">
                16
              </div>
