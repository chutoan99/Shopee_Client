...
function ShopPage(): JSX.Element {
	...
	const { data: dataItemsShop, isLoading: loadingQueyItemsShop } =
		useGetItemsShopQuery(params)
	...
	return (
		<>
			{loadingQueyItemsShop ? (
				...
				<>
					{dataInfoShop?.response && (
						<ShopPageInfoComponent data={dataInfoShop?.response} />
					)}
