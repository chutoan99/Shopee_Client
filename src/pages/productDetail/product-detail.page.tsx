...
import { useCreateCartMutation, useGetCartsQuery } from '../../modules/cart/hooks'
...
import { ProductCommentComponent } from '../../modules/post/components'
			...
			{isLoading ? (
				...
				<>
					...
					<div className='bg-[#f5f5f5] overflow-hidden py-[20px]'>
						<ProductBreadcrumbComponent data={data?.response} />
											...
											{!isEmptyObject(data?.response?.tier_variations) && (
												<>
													<div className='mt-[5px]'>
														<h3 className='text-[#757575] w-[110px] capitalize shrink-0'>
															{data?.response?.tier_variations?.name}
														</h3>
													</div>
													<div className='flex-wrap flex max-w-[32.1875rem]'>
														{data?.response?.tier_variations?.options?.map(
											...
											<>
												...
												<div className='items-center text-[#757575] text-sm leading-[1.05rem] capitalize flex mt-4'>
													...
													<span className='text-[#757575] text-sm leading-[1.05rem] ml-2.5'>
														{data?.response?.stock} sản phẩm có sẵn
													</span>
												</div>
											</>
										</div>
					...
					{/* {!isEmptyObject(data?.response?.shop_info) && (
						<ProductShopComponent data={data?.response?.shop_info} />
					)}
											...
											<div className='pt-[0.9375rem] pb-0 px-[0.9375rem]'>
												...
												<div className='mt-[1.875rem] mb-[0.9375rem] mx-[0.9375rem]'>
														...
														<div className='flex flex-wrap'>
															<div>
																<span className='mr-[5px]'>
																	<NavLink to='# '>
																		{data?.response?.categories?.category_name ||
																			'N/A'}
																	</NavLink>
																</span>
															</div>
													...
													<div>
														{!isEmptyObject(data?.response?.attributes) && (
															<>
																{data?.response.attributes?.option.map(
