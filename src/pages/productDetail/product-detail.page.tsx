...
import { useCreateCartMutation, useGetCartsQuery } from '../../modules/cart/hook'
import ProductBreadcrumbComponent from '../../modules/post/component/product-breadcrumb.component'
import ProductShopComponent from '../../modules/post/component/product-shop.component'
import { ProductCommentComponent } from '../../modules/post/component'
    ...
    <>
      {isLoading ? (
        ...
        <>
          ...
          {!isEmptyObject(data?.response?.shop_info) && <ProductShopComponent data={data?.response?.shop_info} />}
