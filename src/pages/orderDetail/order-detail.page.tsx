          ...
          <div className='px-6 py-10'>
            <div className='relative justify-between box-border flex-nowrap flex'>
              ...
              >
                ...
                <div className='capitalize text-sm text-[rgba(0,0,0,0.8)] leading-5 mt-[1.25rem] mb-[0.25rem] mx-0'>Đơn hàng đã thanh toán</div>
              </div>
              <div
                className='w-[140px] text-center select-none cursor-default z-[1]'
                style={{
              ...
              >
                ...
                >
                  ...
                  >
                    <g>
                      <line fill='none' strokeLinejoin='round' strokeMiterlimit={10} strokeWidth={3} x1='18.1' x2='9.6' y1='20.5' y2='20.5' />
              ...
              <div className='absolute h-1 w-full top-[29px]'>
                <div className='absolute w-[calc(100%_-_140px)] h-full box-border mx-[70px] my-0' style={{ background: 'rgb(224, 224, 224)' }} />
                <div
                  ...
                  <div>
                    <div className='relative flex items-start gap-3 p-0 cuJgPF'>
                      ...
                      <div className='flex items-start justify-start flex-nowrap w-full text-[rgba(0,0,0,0.54)] text-sm'>
                        <div className='flex items-center justify-center h-6 w-6 min-w-[24px]'>
                          <img className='relative h-6 w-6 z-[2]' title='image' src='https://cf.shopee.vn/file/delivered_parcel_active_3x' />
                        </div>
                    ...
                    <div className='relative flex items-start gap-3 p-0'>
                      ...
                      <div className='flex items-start justify-start flex-nowrap w-full text-[rgba(0,0,0,0.54)] text-sm'>
                        ...
                        <div className='m-w-0'>
                          ...
                          <p className='className="leading-5 mt-px mb-2 mx-0"'>Đơn hàng đã đến bưu cục 50-HCM Binh Chanh/Phong Phu LM Hub</p>
                        </div>
                      </div>
                    </div>
                    <div className='relative flex items-start gap-3 p-0'>
                    ...
                    <div className='relative flex items-start gap-3 p-0'>
                      ...
                      <div className='flex items-start justify-start flex-nowrap w-full text-[rgba(0,0,0,0.54)] text-sm'>
                        ...
                        {dataOrder?.createdAt && (
                          <div className='w-[155px] shrink-0 text-[rgba(0,0,0,0.8)] mt-[3px] px-3 py-0'>{formatDate(dataOrder?.createdAt)}</div>
                        )}
                        <div className='m-w-0'>
              ...
              {dataOrder?.final_total && (
                <div className='flex items-center border shadow-[0_1px_1px_rgba(0,0,0,0.05)] mt-0 mb-1.5 mx-0 px-[23px] py-3 rounded-sm border-solid border-[rgba(224,168,0,0.4)] bg-[#fffefb]'>
                  ...
                  <div className='flex-1 text-xs leading-[14px] text-[rgba(0,0,0,0.54)] pl-2 pr-0 py-0'>
                    <span>
                      Vui lòng thanh toán <span className='font-medium text-[#ee4d2d]'>₫{formatPrice(dataOrder?.final_total + 30000)}</span> khi
                      nhận hàng.
                    </span>
                  </div>
                </div>
