        ...
        <div className='grid wide'>
          ...
          <div className='bg-[#fff] mb-2.5 pt-7 pb-6 px-[30px]'>
            ...
            <div>
              ...
              <div className='font-bold text-[#222] inline pr-2.5'>{dataUser.phone ? `Mặc Định: ${dataUser.address} ` : ''}</div>
            </div>
          </div>
            ...
            <div key={index}>
              ...
              <div className='flex bg-[#fafdff] min-w-0 min-h-0 border-b-[rgba(0,0,0,0.09)] border-b border-dashed'>
                ...
                <div className='flex-[6] justify-items-center p-4 border-l-[rgba(0,0,0,0.09)] border-l border-dashed'>
                  <div className='items-center grid-cols-[1fr_0.6fr_1fr_0.3fr]' style={{ display: 'grid' }}>
                    <span className='min-w-0 min-h-0 flex flex-[0_0_auto] text-[#00bfa5] col-start-1 col-end-2 pl-5'>Đơn vị vận chuyển</span>
                    <p>Nhanh</p>
          ...
          <div className='shadow-[0_1px_1px_0rgba_(0,0,0,0.05)] text-right pr-[25px] pt-[15px] border-t-[#f1f0ed] border-t border-solid bg-[#fffefb]'>
            <div>
              <div className='grid grid-cols-[6fr_1fr_1fr] pb-5 border-b-[rgba(0,0,0,0.09)] border-b border-dashed' style={{ display: 'grid' }}>
                <div></div>
                <div>
                ...
                <div>
                  <h3 className='text-sm text-[rgba(0,0,0,0.54)] leading-10'>đ{formatPrice(total)}</h3>
                  <h3 className='text-sm text-[rgba(0,0,0,0.54)] leading-10'>đ{formatPrice(totalShip)}</h3>
                  <h2 className='text-[1.75rem] text-[#ee4d2d] h-10 min-w-[100px]'>₫{formatPrice(total, 0, totalShip)}</h2>
                </div>
              </div>
