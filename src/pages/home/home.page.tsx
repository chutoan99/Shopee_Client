...
import { Banner } from '../../modules/banner/component';
import { BatchList } from '../../modules/batchList/component';
import { Category } from '../../modules/category/component';
import { FlashSale } from '../../modules/flashSale/component';
import { ShopMall } from '../../modules/shopMall/component';
import { TopProduct } from '../../modules/topProduct/component';
import { ProductList } from '../../modules/post/component';
        ...
        <div className="grid wide">
          <div className="row sm-gutter">
            ...
            <div className="col l-12 mo-12 c-12">
              ...
              <ProductList items={dataProduct?.response || []} col={'col l-2 mo-4 c-6'} loading={isLoadingDataProduct} />
