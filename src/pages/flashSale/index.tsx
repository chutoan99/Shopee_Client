        ...
        <div className="grid wide">
          <div className="row sm-gutter">
            ...
            <div style={{ margin: '0px' }}>
              <div>
                <ul className="flex relative h-full" style={{ width: '100%', transform: 'translate(0px, 0px)' }}>
                  <li className="overflow-x-hidden float-left touch-pan-y" style={{ padding: '0px', width: '20%' }}>
                    <div>
                      <NavLink
                        to="/"
