                  ...
                  <div className='px-6 py-3 bg-[#fff]'>
                    <div className='flex items-center justify-between pt-0 pb-3 px-0'>
                      <div className='flex items-center whitespace-nowrap'>
                        ...
                        <div className='max-w-[200px] text-sm font-semibold overflow-hidden text-ellipsis ml-2 mr-0 my-0'>{cart?.shop_name}</div>
                              ...
                              <div>
                                <div>
                                  <span className='align-middle text-sm leading-4 text-[rgba(0,0,0,0.87)]'>
                                    ...
                                    >
                                      <h3 className='line-through text-[#ccc]'>đ{formatPrice(post?.price_before_discount, post?.amount)}</h3>
            ...
            <div className='w-full h-[600px] text-center'>
              ...
              >
                <div className='A849D8'>
                  <img src='https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/5fafbb923393b712b96488590b8f781f.png' alt='emptyOrder' />
                </div>
